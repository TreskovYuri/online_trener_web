...
//         // Подключение к базе данных
//         await sequelize.authenticate();
//         // Сверка состояния базы данных со схемой данных в нашем приложении
//         await sequelize.sync();
//         console.log('\x1b[36m%s\x1b[0m', `Установлено подключение к базе данных`);
//     } catch (e) {
//         ColorConsole.red('\x1b[31m%s\x1b[0m', "ОШИБКА ПОДКЛЮЧЕНИЯ К БАЗЕ ДАННЫХ");
//         ColorConsole.red(e);
//     }
// };
...
//                 io.to(`user_${userId}`).emit('newMessageNotification', { message, roomID });
//             } catch (e) {
//                 ColorConsole.red(e);
//             }
//         }
...
//         debug && ColorConsole.bgGreen(`Регистрация пользователя в личном канале: user_${userId}`);
