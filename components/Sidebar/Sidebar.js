  ...
  return (
    <div className={css.container}>
      ...
      <div className={css.exitContainer}>
        <Link href='admin/profile' className={mobx.page==='settings'?`${css.link} ${css.active}`:`${css.link}`}><Image src={settings} className={css.img} onClick={()=>mobx.setPage('settings')}/>Настройки</Link>
